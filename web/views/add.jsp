...
<div class="w3-container w3-padding">
    <%
        User userForAddition = (User) request.getAttribute("userForAddition");
        ...
        if (userForAddition != null) {
            if (listOfUsers.size() > 0) {
                for (int i = 0; i < listOfUsers.size(); i++) {
                    if (userForAddition.equals(listOfUsers.get(i))) {
                        out.println(outParameter + "User: '" + userForAddition.getName() +
